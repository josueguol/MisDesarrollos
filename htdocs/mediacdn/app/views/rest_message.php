...
<html>
    <head>
        ...
        <![endif]-->
        <title>Chemico - Animated 404 Error Page</title>
    ...
    <body>
        ...
        <section>
            <div class="container">
                <div class="row row1">
                    <div class="col-md-12">
                        <h3 class="center capital f1 wow fadeInLeft" data-wow-duration="2s">Algo sali&oacute; mal</h3>
                        <h1 id="error" class="center wow fadeInRight" data-wow-duration="2s">0</h1>
                        <p class="center wow bounceIn" data-wow-delay="2s">P&aacute;gina no encontrada.</p>
                    </div>
                </div>
