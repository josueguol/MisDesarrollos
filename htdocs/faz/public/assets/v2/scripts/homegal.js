...
window.addEventListener("scroll", function(a) {
    ...
    if (window.scrollY >= 1200 && firedGray === false) {
        animateValue("pesos", 0, 7866453, 3500);
        animateValue("chair", 0, 3026, 3500);
        firedGray = true
    }
    if (window.scrollY >= 10) {
	h4cLogo.removeClass("bounceInRight").addClass("bounceInLeft");
        pcLogo.removeClass("bounceInLeft").addClass("bounceInRight")
    } else {
	h4cLogo.removeClass("bounceInLeft").addClass("bounceInRight");
        pcLogo.removeClass("bounceInRight").addClass("bounceInLeft")
    }
}, true);
