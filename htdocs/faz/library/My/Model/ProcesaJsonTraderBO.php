 ...
 */
class My_Model_ProcesaJsonTraderBO{
    ...
    public function organizarDatosJson($LosDatos,$tipoDato){//$tipoDato 1= Tema , 2 Autor
    	...
    	foreach ($LosDatos as $key => $datos) {
    		...
    		$LosDatos[$key]['urlC'] 			= "/contenido/noticias/articulo/".$idContenido."/".$urlTitulo;
    ...
    public function consultaDatosArticulo($LosDatos,$banderacontador = 0,$cantidadRegistros = 10){
    	...
    	foreach ($LosDatos as $key => $datos) {
    		...
    		$nuevosDatos[$key]['urlC'] 			= "/contenido/noticias/articulo/".$idContenido."/".$urlTitulo;
    ...
    /*
     * Procesa las imagenes que viene del json para mostrarla al full...
     */
